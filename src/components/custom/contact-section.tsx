            ...
            >
              <div className="group bg-black/20 backdrop-blur-sm rounded-2xl border border-white/10 p-8 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20">
                ...
                <div className="space-y-6">
                  <Link
                    href="mailto:work.krishnat@gmail.com"
                    className="flex items-center gap-4 text-gray-400 hover:text-primary transition-colors"
                  >
                    <Mail className="h-5 w-5" />
                    <span>work.krishnat@gmail.com</span>
                  </Link>
                  <Link
                    href="https://linkedin.com/in/krishnathakkar29"
                    target="_blank"
                    className="flex items-center gap-4 text-gray-400 hover:text-primary transition-colors"
                  >
                    <Linkedin className="h-5 w-5" />
                    <span>linkedin.com/in/krishnathakkar29</span>
                  </Link>
                  <Link
                    href="https://github.com/krishnathakkar29"
                    target="_blank"
                    className="flex items-center gap-4 text-gray-400 hover:text-primary transition-colors"
                  >
                    <Github className="h-5 w-5" />
                    <span>github.com/krishnathakkar29</span>
                  </Link>
                </div>
              </div>
            </motion.div>
